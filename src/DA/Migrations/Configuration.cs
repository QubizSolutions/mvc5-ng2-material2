namespace Tesseract.DA.Migrations
{
    ...
    public sealed class Configuration : DbMigrationsConfiguration<Tesseract.DA.AuthorsDBContext>
    {
        ...
        protected override void Seed(Tesseract.DA.AuthorsDBContext context)
        {
            ...
            Author.Entity.Author author1 = GetAuthorByID(context, authorID1);
            Author.Entity.Author author2 = GetAuthorByID(context, authorID2);
            Author.Entity.Author author3 = GetAuthorByID(context, authorID3);

            context.Articles.AddOrUpdate(p => p.Id,
                new Article.Entity.Article
                {
                    Id = articleID1,
                    Title = "The avengers",
                    ...
                    Year = 1995,
                    Authors = new List<Author.Entity.Author> { author1, author2, author3 }
                },
                new Article.Entity.Article
                {
                    Id = articleID2,
                    ...
                    Year = 2017,
                    Authors = new List<Author.Entity.Author> { author1 }
                },
                new Article.Entity.Article
                {
                    Id = articleID3,
                    ...
                    Year = 2017,
                    Authors = new List<Author.Entity.Author> { author2 }
                },
                new Article.Entity.Article
                {
                    Id = articleID4,
                    ...
                    Year = 2017,
                    Authors = new List<Author.Entity.Author> { author3 }
                });
            context.SaveChanges();
        }

        private Author.Entity.Author GetAuthorByID(Tesseract.DA.AuthorsDBContext context, Guid id)
        {
